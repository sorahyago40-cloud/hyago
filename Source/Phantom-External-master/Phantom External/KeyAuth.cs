...
namespace KeyAuth
{
    public class api
    {
        ...
        /// <param name="">Your OwnerID, found in your account settings.</param>
        /// <param name="">Application Secret</param>
        /// <param name="">Application Version, if version doesnt match it will open the download link you set up in your application settings and close the app, if empty the app will close</param>
        ...
        internal void login(string text)
        {
